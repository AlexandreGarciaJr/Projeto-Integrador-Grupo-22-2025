...
- [Scripts SQL](docs/pi_ads.sql) com comandos DML e DDL para criação e manipulação do banco de dados;
- [Documentação](PI - 1entrega.pdf) detalhada com especificações dos casos de uso;
